	...
	public ManhuntSetSpawnCountCommand(CommandDispatcher<CommandSourceStack> dispatcher) {
		...
		dispatcher.register(Commands.literal("ManhuntSetSpawnCount")
				...
				.executes((command) -> {
					...
					command.getSource().getPlayerOrException()
							.sendSystemMessage(Component.literal(
									"Global dedicated-respawn count set to infinite"
							));
					return 0;
		})));
		dispatcher.register(Commands.literal("ManhuntSetSpawnCount")
				...
				.executes((command) -> {
					...
					command.getSource().getPlayerOrException()
							.sendSystemMessage(Component.literal(
									"Overworld dedicated-respawn count set to infinite"
							));
					return 0;
		}))));
		dispatcher.register(Commands.literal("ManhuntSetSpawnCount")
				...
				.executes((command) -> {
					...
					command.getSource().getPlayerOrException()
							.sendSystemMessage(Component.literal(
									"Nether dedicated-respawn count set to infinite"
							));
					return 0;
		}))));
		dispatcher.register(Commands.literal("ManhuntSetSpawnCount")
				...
				.executes((command) -> {
					...
					command.getSource().getPlayerOrException()
							.sendSystemMessage(Component.literal(
									"End dedicated-respawn count set to infinite"
							));
					return 0;
		}))));
		dispatcher.register(Commands.literal("ManhuntSetSpawnCount")
